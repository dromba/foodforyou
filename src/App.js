...
const item0 = {
  id: 0,
  img_url:
    "https://static.adweek.com/adweek.com-prod/wp-content/uploads/2018/10/Screen-Shot-2018-10-17-at-1.25.22-PM.png",
...
class App extends Component {
  ...
  handleSelection = e => {
    if (
      ...
      document.getElementById("new-item-menu-item").style.textDecoration =
        "underline";
      document.getElementById("list-menu-item").style.textDecoration = "none";
    } else {
      document.getElementById("list-menu-item").style.textDecoration =
        "underline";
      document.getElementById("new-item-menu-item").style.textDecoration =
        "none";
    }
        ...
        <div className="container">
          <div className="topnav">
            <div className="menu-items">
              <Link onClick={this.handleSelection} to={toList}>
                <p id="list-menu-item">List</p>
              </Link>
              <Link onClick={this.handleSelection} to={toNewItem}>
                <p id="new-item-menu-item">New Item</p>
              </Link>
            </div>
          ...
          <Switch>
            ...
            <Route
              path="/"
              render={() => (
                <List items={items} deleteFromList={this.deleteFromList} />
              )}
            />
          </Switch>
        </div>
